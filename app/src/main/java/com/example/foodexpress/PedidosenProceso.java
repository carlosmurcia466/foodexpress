...
public class PedidosenProceso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedidosen_proceso);

        btnverticket=findViewById(R.id.idverpedidosenproceso);
        listView=findViewById(R.id.listaticketsenproceso);
        init();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent vpc=new Intent(getApplicationContext(),verpedidosenproceso.class);
                vpc.putExtra("ticket_cliente",tabla[i][0]);
                startActivity(vpc);
            }
        });
    ...
    public  void init(){
        ...
        String url="https://foodexpress.webcindario.com/listarticketscocina.php?id_proceso=2&fecha="+date;
