...
public class verpedidosenproceso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verpedidosenproceso);

        btnverticket=findViewById(R.id.btnenviarpedidoacliente);
        btnsalir=findViewById(R.id.btnsalirprocesocliente);
        tvticket=findViewById(R.id.tvticketprocesocliente);
        listView=findViewById(R.id.listadetalleprocesocliente);
        ...
        btnverticket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(verpedidosenproceso.this);
                alertDialog.setMessage("¿desea enviar orden a cliente?");
                alertDialog.setTitle("poner en ruta la orden: "+ ticket_cliente);
                ...
                alertDialog.setPositiveButton("Sí", new DialogInterface.OnClickListener()
                {
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        solicitud("https://foodexpress.webcindario.com/enviarpedidoaruta.php");
    ...
    public  void init(){
        ...
        String url="https://foodexpress.webcindario.com/listarpedidostickets.php?id_proceso=2&fecha="+date+"&ticket_cliente="+ticket_cliente;
