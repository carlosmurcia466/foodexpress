...
public class listarAdministradores extends AppCompatActivity {
    ...
    public static void setTabla(String[][] tabla) {
        listarAdministradores.tabla = tabla;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_administradores);
        btnregresar=findViewById(R.id.btnregresaradmin);
    ...
    public  void init(){
        ...
        String url="https://foodexpress.webcindario.com/listarAdministradores.php";
