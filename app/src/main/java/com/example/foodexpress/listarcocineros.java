...
public class listarcocineros extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listarcocineros);
        btnregresar=findViewById(R.id.btnregresarcocina);
        listView=findViewById(R.id.listacocineros);

        Bundle  parametros=this.getIntent().getExtras();
        if(parametros !=null) {

            String id_usuario = parametros.getString("id");
    ...
    public  void init(){
        ...
        String url="https://foodexpress.webcindario.com/listarCocineros.php";
