...
public class PedidosCocina extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnverticket=findViewById(R.id.idverticketcocina);
        listView=findViewById(R.id.listaticketscocina);
        init();
       ...
       listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
           ...
           public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
               ...
               Intent  vpc=new Intent(getApplicationContext(),VerPedidosCocina.class);
    ...
    public  void init(){
        ...
        String url="https://foodexpress.webcindario.com/listarticketscocina.php?id_proceso=1&fecha="+date;
